package com.itplh.hero.db.genterate;
...
//        //datasource数据源配置
        ...
        dataSource.setUrl("jdbc:mysql://localhost:3306:3306/mybatisplus_db?serverTimezone=UTC");
...
//        会在D盘生成一个com文件，但是这个位置是不对的，需要我们再进一步配置
        ...
        globalConfig.setOutputDir(System.getProperty("user.dir")+"/hero-helper/src/main/java");
        //globalConfig.setOutputDir(System.getProperty("user.dir")+"\\src\\main\\java");
        //      \\src\\main\\java
        //设置完之后是否打开资源管理器   NO
        globalConfig.setOpen(false);
        //设置作者
        globalConfig.setAuthor("hegf");
        //设置是否覆盖原始生成的文件
        ...
        packageConfig.setParent("com.itplh.hero");
        //设置实体类包名
